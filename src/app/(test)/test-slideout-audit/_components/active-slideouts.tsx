...
export function ActiveSlideouts({
  ...
  return (
    <>
        ...
        slideout={
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              This is the complex SlideoutWrapper component with multi-tab interface and feature flags. This component
              is still used in production layouts and requires careful evaluation for migration.
            </p>
            <div className="rounded-[var(--radius-card)] border border-yellow-200/50 bg-yellow-50 p-4 dark:border-yellow-800/50 dark:bg-yellow-950/20">
              <h4 className="text-foreground mb-2 font-medium">⚠️ Production Usage</h4>
              <p className="text-muted-foreground text-sm">
                This component is actively used in layout files and provides complex multi-tab functionality
                event-driven behavior. Migration requires careful planning.
              </p>
            </div>
          </div>
        }
      ...
      <FloatingVideoPlayer isOpen={floatingOpen} onClose={onCloseVideo} video={currentVideo} mode="fixed" />
      ...
      >
        <div className="space-y-4">
          <div className="rounded-[var(--radius-card)] border border-red-200/50 bg-red-50 p-4 dark:border-red-800/50 dark:bg-red-950/20">
            <h3 className="text-foreground mb-2 text-lg font-semibold">Traditional Modal Behavior</h3>
            <p className="text-muted-foreground text-sm">
