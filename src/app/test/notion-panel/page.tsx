...
export default function NotionPanelTest() {
  ...
  const [properties, setProperties] = useState([
    { id: '1', type: 'url' as const, name: 'Project URL', icon: 'link' },
    { id: '2', type: 'status' as const, name: 'Status', value: { label: 'In Progress', color: 'warning' }, icon: 'burst' },
    { id: '3', type: 'text' as const, name: 'Owner', value: 'John Doe', icon: 'user' },
    { id: '4', type: 'date' as const, name: 'Due Date', value: '2024-02-15', icon: 'calendar' }
  ]);
