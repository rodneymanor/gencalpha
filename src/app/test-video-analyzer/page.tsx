...
import { TopBottomVideoAnalyzer } from "./_components/top-bottom-video-analyzer";

export default function TestVideoAnalyzerPage() {
  const [floatingOpen, setFloatingOpen] = useState(false);
  const [topBottomOpen, setTopBottomOpen] = useState(false);
  ...
  return (
    <div className="bg-background min-h-screen p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Compare floating vs top-to-bottom slideout panels for the video analyzer
          </p>
        </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="mb-4 text-center">
                ...
                <h3 className="text-foreground mb-2 text-xl font-semibold">Top-to-Bottom Slideout</h3>
                <p className="text-muted-foreground text-sm">
                  Full-height panel that slides down from top, maximizing analysis space
                </p>
              </div>
              <div className="space-y-3">
                <div className="text-muted-foreground text-sm">
                ...
                <div className="text-muted-foreground text-sm">
                  <strong>Cons:</strong>
                  <ul className="mt-1 ml-4 list-disc space-y-1">
                    <li>Covers entire page</li>
                    <li>Loses page context</li>
                    <li>May feel too heavy</li>
                  </ul>
                </div>
                <Button onClick={() => setTopBottomOpen(true)} className="w-full" size="lg" variant="secondary">
                  Test Top-to-Bottom Slideout
                </Button>
              </div>
            </CardContent>
          </Card>
      ...
      <TopBottomVideoAnalyzer isOpen={topBottomOpen} onClose={() => setTopBottomOpen(false)} video={sampleVideo} />
    </div>
  );
}
