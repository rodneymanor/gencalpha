...
export const AdvancedSlidingSwitch: React.FC<AdvancedSlidingSwitchProps> = ({
  ...
  return (
    <div className="border-border bg-muted relative inline-flex h-8 w-[110px] items-center overflow-hidden rounded-[var(--radius-button)] border p-1 shadow-[var(--shadow-input)]">
