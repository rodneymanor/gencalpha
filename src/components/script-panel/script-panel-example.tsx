...
Save this for your next video! Follow for more content creation tips that actually work. What type of videos are you creating? Let me know in the comments!`,
    components: processScriptComponents([
      ...
      },
      {
        ...
        type: "nugget", 
        label: "Golden Nugget",
        content: "The key is to structure your content in four parts: First, grab attention with a pattern interrupt. Second, build a bridge that creates relatability. Third, deliver massive value in a concise, actionable format. And finally, guide your viewer to take the next step. When you combine these elements with authentic storytelling and clear visuals, your engagement rates will skyrocket. This exact formula helped me go from 100 views to 100K in just 30 days.",
        icon: "G"
      },
      {
        id: "cta-1",
  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground mb-2">Script Panel Integration Example</h1>
          <p className="text-muted-foreground">
            This example demonstrates how to integrate the ScriptPanel component with the UnifiedSlideout
            system using the modular approach where content handles its own header and layout.
          </p>
        </div>

        <div className="bg-muted/50 border border-border rounded-[var(--radius-card)] p-6">
          <h2 className="text-lg font-semibold text-foreground mb-3">Features Demonstrated</h2>
          <ul className="text-muted-foreground space-y-2 text-sm">
            <li>• <strong>Modular Content:</strong> ScriptPanel handles its own header, tabs, and layout</li>
            <li>• <strong>No Default Header:</strong> UnifiedSlideout shows no header when showHeader=false</li>
            <li>• <strong>Full Height:</strong> Content component takes full slideout height</li>
            <li>• <strong>Copy Functionality:</strong> Individual components and full script copying</li>
            <li>• <strong>Download Support:</strong> Script export in multiple formats</li>
            <li>• <strong>Script Analytics:</strong> Word count and duration calculation</li>
        ...
        <div className="bg-card border border-border rounded-[var(--radius-card)] p-4">
          <h3 className="font-medium text-foreground mb-2">Usage Code:</h3>
          <pre className="text-xs text-muted-foreground bg-muted p-3 rounded-[var(--radius-button)] overflow-x-auto">
{`import { UnifiedSlideout, useSlideout } from "@/components/ui/unified-slideout";
    ...
    <>
      ...
      <UnifiedSlideout
        ...
        config={{
          ...
          showCloseButton: false,   // ScriptPanel has its own close button
