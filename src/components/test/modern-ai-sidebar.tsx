...
export function ModernAISidebar({ selectedItem, onItemSelect }
: ModernAISidebarProps) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-gray-500">
                    ...
                    />
                    <span>AI Assistant {isAIActive ? "Active" : "Idle"}
</span>
                  </div>
                </div>
              </div>
        ...
        <div className={isCollapsed ? "py-4" : "p-4"}>
          {!isCollapsed ? (
            <button
              ...
              className={cn(
                "flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-brand",
            ...
            <div className="group relative mx-auto">
              <button
                ...
                className={cn(
                  "mx-auto flex h-10 w-10 items-center justify-center rounded-lg bg-brand text-white transition-all duration-200 ease-out",
                  "shadow-sm hover:bg-brand-600 hover:shadow-md active:bg-brand-700",
                )}
              ...
              {quickGenerators.map((generator) => (
                ...
                >
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <div className="text-xs font-medium text-gray-700 group-hover:text-gray-900">{generator.title}
</div>
                  </div>
                  <div className="text-xs text-gray-500">{generator.uses}
 uses</div>
                </button>
              ))}
 ...
 className="mb-6">
              {!isCollapsed && (
                <div className="mb-3 flex items-center justify-between">
                  <h3 className="text-xs font-medium tracking-wide text-gray-400 uppercase">{section.title}
</h3>
                ...
                <div className="space-y-1">
                  {section.items.map((item) => (
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <>
                          <span className="flex-1 text-sm font-medium">{item.title}
</span>
