    ...
    <div className="grid aspect-[9/16] max-h-[80vh] w-full place-items-center bg-black/95">
      {!videoSrc ? (
        <div className="flex min-h-[400px] w-full flex-col items-center justify-center gap-4 p-6">
          ...
          <p className="text-muted-foreground text-sm">Paste a TikTok, Instagram Reels, or YouTube Shorts URL</p>
          ...
          <div>
            <Button
              variant="secondary"
              onClick={() => onLoadVideo("https://www.tiktok.com/@sarahcreates/video/123456789")}
              className="rounded-[var(--radius-button)]"
            >
              Load Sample Video
            </Button>
