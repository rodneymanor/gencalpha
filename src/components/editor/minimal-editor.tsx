...
export function MinimalEditor({ value, onChange }: MinimalEditorProps) {
  ...
  return (
    <div className="border rounded-lg p-4">
      ...
      <div 
        ref={editorRef} 
        className="min-h-[200px] border rounded p-3 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500"
        style={{ 
      ...
      <div className="mt-2 text-xs text-gray-500">
        Minimal BlockNote implementation with improved error handling.
      </div>
    </div>
  );
}
