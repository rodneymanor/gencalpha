  ...
  const actions: Array<Omit<ActionCardProps, "onAction" | "disabled">> = [
    {
      ...
      icon: <FileText className="h-full w-full" strokeWidth={1.5} />,
      action: "transcribe",
    ...
    },
    {
      ...
      icon: <Copy className="h-full w-full" strokeWidth={1.5} />,
      action: "emulate",
    ...
    },
    {
      ...
      icon: <Lightbulb className="h-full w-full" strokeWidth={1.5} />,
      action: "ideas",
    ...
    },
    {
      ...
      icon: <Fish className="h-full w-full" strokeWidth={1.5} />,
      action: "hooks",
