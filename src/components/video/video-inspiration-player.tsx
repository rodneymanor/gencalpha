...
> = ({ videoUrl, views, likes, comments, shares }) => (
  <div className="flex h-full flex-col">
    ...
    <div className="mt-4 flex-shrink-0">
      <div className="bg-card border-border mx-auto flex w-full max-w-[268px] items-center justify-between rounded-[var(--radius-card)] border p-3 shadow-[var(--shadow-soft-drop)]">
