...
/**
 * Enhanced hook for calculating script analytics with component-level readability analysis
 */
 ...
 */
export function processScriptComponents(
  components: Omit<ScriptComponent, "wordCount" | "estimatedDuration">[],
): ScriptComponent[] {
